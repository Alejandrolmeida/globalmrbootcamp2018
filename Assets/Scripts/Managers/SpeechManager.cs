...
public class SpeechManager : MonoBehaviour {
    ...
    private String TTSKey = "366608d55dfd4c49a0dee574e6179d11";
    //private String TTSKey = "13e92332a50e4a4e98523439674f9f35";
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        Task<string> authenticating = auth.Authenticate("https://northeurope.api.cognitive.microsoft.com/sts/v1.0/issueToken",
                                                 TTSKey); // INSERT-YOUR-BING-SPEECH-API-KEY-HERE
    ...
    private void PlayAudio(Stream audioStream)
    {
        ...
        if (size > 0)
        {
            try
            {
                ...
                //Demo final
               // MyRobotMgr.instance.speeching = true;
               MyRobotMgr.instance.speeching = true;
            }
            catch (Exception ex)
            {
    ...
    public void Speak(string message)
    {
        try
        {
            ...
            // Endpoint
            string requestUri = "https://northeurope.tts.speech.microsoft.com/cognitiveservices/v1";
           // string requestUri = "https://westus.tts.speech.microsoft.com/cognitiveservices/v1";
            ...
            Task<Stream> Speaking = cortana.Speak(CancellationToken.None, new Synthesize.InputOptions()
            {
                ...
                // You can also customize the output voice.
                VoiceName = voiceName,
    ...
    private static float[] ToUnityAudio(byte[] wavAudio, out int sampleCount, out int frequency)
    {
        ...
        {
            Debug.Log($"Error occurred converting audio data to float array of size {wavAudio.Length} at position {pos}.{ex}");
        }
